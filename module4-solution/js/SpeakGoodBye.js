...
(function (window) {
  ...
  // STEP 7:
  // Create an object, called 'byeSpeaker' to which you will
  ...
  // STEP 8:
  // Rewrite the 'speak' function such that it is attached to
  // the byeSpeaker object instead of being a standalone function.
  // See Lecture 52, part 2
  byeSpeaker.speak = function () {
    console.log(speakWord + " " + bySpeaker.name);
  }
